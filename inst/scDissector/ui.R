                  ...
                  tabPanel("Clusters", 
                    fluidRow(
                          ...
                          column(6,
                            ...
                            wellPanel(
                              h4("Gene Selection"),
                              selectInput("inSelectGenesFrom","Select From:",choices=c("All genes","Without RPs & Mito","TFs","Surface markers")),
          ...
          #                  actionButton("inSaveAnnot", "Save Annotations"))
                ...
                tabPanel("Cells", fluidRow(
                      ...
                      wellPanel(
                        ...
                        checkboxInput("inGlobalOrder",label = "Global Order",value = F)),
